...
```text
이 저장소의 최신 안정 릴리스 v0.3.2 기준으로 Codex Obsidian Manuscript Starter를 Windows에 처음부터 설치해줘.

나는 Codex만 설치한 초보자다. 설치 중에는 다음 원칙을 지켜줘.

1. GitHub 저장소는 ARTHONG1/codex-obsidian-manuscript-starter만 사용하고, v0.3.2 release ref를 고정해줘.
