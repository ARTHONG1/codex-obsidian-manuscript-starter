...
8. Create an immutable `v0.3.0` GitHub release only after the above checks pass. Publish SHA-256 values for release assets and verify the tag points to the reviewed commit.
9. Test the README commands from a clean checkout using `--ref v0.3.0`; do not publish a dirty working tree or planning/Vault artifacts.
