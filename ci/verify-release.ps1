...
$patterns = @(
    ...
    "docs/TROUBLESHOOTING.md", "docs/RELEASE.md", "docs/RELEASE_NOTES_v0.7.1.md",
...
$required = @(
    ...
    "docs/RELEASE.md", "docs/RELEASE_NOTES_v0.7.1.md",
...
if ($pluginJson.version -ne "0.7.1") { Fail "bootstrap identity/version is not v0.7.1." }
